...
export default function App() {
  ...
  async function start(kind: 'original' | 'attempt') {
    ...
    } catch { setMicBusy(false); releaseMicrophone(); fail('Не удалось включить микрофон. Проверь разрешение браузера.'); }
  }
