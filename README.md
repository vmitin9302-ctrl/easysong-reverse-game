...
- только онлайн-дуэль на двух устройствах через приватную комнату по invite URL;
- загадчик вводит секретную фразу и записывает её, а соперник повторяет перевёрнутый звук, слушает свою запись в нормальном звучании и пишет догадку;
...
packages/audio-engine  локальная подготовка и разворот аудио
